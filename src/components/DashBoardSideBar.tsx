...
const DashBoardSideBar = () => {
  return (
    <section className=" md:w-42 border-r-2 absolute bottom-0 inset-0 border-white/10 px-2 flex justify-center items-center md:pt-10 lg:pt-20">
      <nav className="flex md:flex-col w-full md:h-full md:gap-4 py-10 items-center  md:items-start md:justify-start justify-between px-8 md:px-3 ">
        <Link
          href={"/dashboard"}
          className="flex text-center md:flex-col md:justify-start w-fit  justify-between"
        >
          <ul className=" py-2 w-fit  rounded-md shadow-sm shadow-sky group">
        ...
        <Link
          ...
          className="flex text-center md:flex-col justify-start w-fit "
        >
          <ul className=" py-2 w-fit  rounded-md shadow-sm shadow-sky group">
            <li className="text-center flex items-center px-4 justify-start gap-1 group-hover:underline  w-full capitalize text-base font-normal text-nowrap">
